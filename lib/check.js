...
(function() {
  ...
  Check = (function() {
    function Check(url1, noteBook, recursive) {
      this.url = url1;
    ...
    Check.prototype.checkAdd = function(data, cb, recursiveCB) {
      var self;
      self = this;
      return async.eachSeries(data.data, function(item, callback) {
        ...
        if (self.recursive) {
          return self.getList(data.paging.next, recursiveCB);
        } else {
          return cb();
        }
      });
